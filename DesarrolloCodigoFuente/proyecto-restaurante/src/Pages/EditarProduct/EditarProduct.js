...
import {verProducto} from "../../services/Productos.service";
...
const EditProduct = () => {
  ...
  async function handleSubmit() {
    ...
    axios.put(`http://localhost:4000/api/productos/verproductos/modificar/${producto._id}`, updateProduct);
      ...
      <div className="createProduct-content">
        ...
        <div className="row">
          <div className="col-md-6">
            ...
            >
              ...
              <option value="6175ddbaab49ae193a6e0f16">Carnes a la parrilla</option>
            ...
            {categoriaInvalid&&<label className="label-error">
          ...
          <div className="col-md-6">
            ...
            />
             {nombreInvalid&&<label className="label-error">
              Nombre obligatorio
            </label>}
          </div>
        </div>
        <div className="row">
          <div className="col-md-6">
            ...
            />
             {cantidadInvalid&&<label className="label-error">
          ...
          <div className="col-md-6">
            ...
            <Input
              ...
              param={costoInvalid}
            />
            {costoInvalid&&<label className="label-error">
              Costo obligatorio
            </label>}
          </div>
        </div>
