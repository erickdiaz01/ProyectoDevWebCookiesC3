...
class ModuloAdminVentas extends Component {
  state = {
    venta: [],
    idVenta: [],
    idProducto: [],
  ...
  async componentDidMount() {
    const res = await axios.get("http://localhost:4000/api/gestionventas");
    console.log(res);
    this.setState({venta:res.data})
  }
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <Table striped bordered hover responsive className="tabla">
                ...
                <tbody>
                  {this.state.venta.map(venta=>(<tr key={venta._id}>
                    <td>
                      {venta._id}
                    </td>
                    <td>
